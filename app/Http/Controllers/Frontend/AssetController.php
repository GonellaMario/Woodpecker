...
class AssetController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.assets.create', compact('categories', 'statuses', 'locations', 'assigned_tos'));
    }
    ...
    public function edit(Asset $asset)
    {
        ...
        return view('frontend.assets.edit', compact('categories', 'statuses', 'locations', 'assigned_tos', 'asset'));
    }
